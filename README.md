# Arikita in Super Mario 64

- This repo is based on Super Mario 64's pc port 
- It contains a full decompilation of Super Mario 64 (J), (U), and (E) with minor exceptions in the audio subsystem.
...
It is possible to build N64 ROMs as well with this repository. See https://github.com/n64decomp/sm64 for instructions. You need to use the build flag `TARGET_N64=1`.
...
Pull requests to the main sm64-port repo are welcome. For major changes, please open an issue first to
