...
const LevelScript level_intro_entry_1[] = {
    ...
    CLEAR_LEVEL(),
    SLEEP(/*frames*/ 2),
    EXIT_AND_EXECUTE(/*seg*/ 0x14, _introSegmentRomStart, _introSegmentRomEnd, level_main_menu_entry_1), // switched from level_main_menu_entry_2 to remove the goddard model
};
